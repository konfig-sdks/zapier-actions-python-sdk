...
from zapier_actions_python_sdk.exceptions_base import ApiValueError
from zapier_actions_python_sdk.exceptions import ClientConfigurationError
from zapier_actions_python_sdk.exceptions import InvalidHostConfigurationError
...
conf = zapier_actions_python_sdk.Configuration(
    ...
    def __init__(self, host=None,
                 ...
                 discard_unknown_keys=False,
                                  access_point_api_key_header=None,
                                  access_point_api_key_query=None,
                                  session_auth=None,
        ...
        """Constructor
        """
        self.host = "https://actions.zapier.com" if host is None else host
        """Default Base url
        """
        ...
        self.api_key = {}
        if access_point_api_key_header:
            self.api_key['AccessPointApiKeyHeader'] = access_point_api_key_header
        if access_point_api_key_query:
            self.api_key['AccessPointApiKeyQuery'] = access_point_api_key_query
        if session_auth:
            self.api_key['SessionAuth'] = session_auth
        ...
        """Logging Settings
        """
        self.logger = logging.getLogger("zapier_actions_python_sdk")
    ...
    def auth_settings(self):
        ...
        """
        auth = {}
        if 'AccessPointApiKeyHeader' in self.api_key:
            auth['AccessPointApiKeyHeader'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'X-API-Key',
        ...
        if 'AccessPointApiKeyQuery' in self.api_key:
            auth['AccessPointApiKeyQuery'] = {
                'type': 'api_key',
                'in': 'query',
                'key': 'api_key',
                'value': self.get_api_key_with_prefix(
